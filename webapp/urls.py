...
from webapp.views.books import (
    BookCreateView,
    BookUpdateView,
    BookDetail,
    BookDeleteView,
...
urlpatterns = [
    ...
    path(
        "book/<int:pk>/update/", BookUpdateView.as_view(), name="book_update"
    ),
    path(
        "book/<int:pk>/delete/",
    ...
    path(
        "book/<int:pk>/toggle-favorite/",
        ToggleFavoriteBookView.as_view(),
